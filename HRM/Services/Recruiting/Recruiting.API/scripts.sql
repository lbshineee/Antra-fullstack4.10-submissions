...
VALUES (N'20230515191901_InitialMigration', N'7.0.5');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230516144455_UpdatingJobsTable', N'7.0.5');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230516145639_CreatingCandidateTable', N'7.0.5');
GO
...
ALTER TABLE [Jobs] ADD [JobStatusLookUp_Id] int NOT NULL DEFAULT 0;
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230516150351_JobStatusLookUpTable', N'7.0.5');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230516151456_CreatingSubmissionsTable', N'7.0.5');
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Submissions]') AND [c].[name] = N'CandidatedId');
IF @var3 IS NOT NULL EXEC(N'ALTER TABLE [Submissions] DROP CONSTRAINT [' + @var3 + '];');
ALTER TABLE [Submissions] DROP COLUMN [CandidatedId];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230516152541_SubmissionsTable', N'7.0.5');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230516153932_UpdatingCandidateTable', N'7.0.5');
GO
